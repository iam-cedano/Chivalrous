...
function CartButton() {
    ...
    return (orderCount > 0 ? <FilledCartButton orderCount={orderCount} /> : <EmptyCartButton />);
}
...
function FilledCartButton({ orderCount }: CartButtonProps) {
    const openCart = () => {
    };

    return (
        <button className="bg-[#39B437] p-1.5 rounded-[10px] gap-2.5 flex items-center m-auto" onClick={openCart}>
